...
<form method="POST" action="{{ route('despesas_fixas.store')}}">
    @csrf
    ...
    <div class="card mb-2">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <x-form-group name='data_quitacao' type='date' value="{{ old('data_quitacao') }}">Data da quitação</x-form-group>
                </div>

                <div class="col-4">
                    <x-form-group name='dia_vencimento' type='number' value="{{ old('dia_vencimento') }}">Dia vencimento</x-form-group>
                </div>

                <div class="col-4">
                    <x-form-group name='valor' value="{{ old('valor') }}" type='number'>Valor</x-form-group>
                </div>
