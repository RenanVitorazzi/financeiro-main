    ...
    <table  class='page_break'>
        ...
        <tbody>
            <tr>
                ...
                <td>@moeda(350)</td>
                <td>
                    @moeda((350) * $vendas->sum('peso') * ($comissaoRepresentante["porcentagem_peso"] / 100))
                </td>
            </tr>
            <tr>
                ...
                <td>@moeda(13)</td>
                <td>
                    @moeda((13) * $vendas->sum('fator') * ($comissaoRepresentante["porcentagem_fator"] / 100))
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><b>@moeda(
                    (350) * $vendas->sum('peso') * ($comissaoRepresentante["porcentagem_peso"] / 100)
                    +
