...
<form method="POST" action="{{ route('consignado.store')}}">
    @csrf
    <div class="row">
        <div class="col-4">
            <x-form-group name="data" type='date' value="{{ old('data') }}" >
                Data
            </x-form-group>
        </div>
        <div class="col-4">
            <x-form-group name="peso" value="{{ old('peso') }}">
                Peso
            </x-form-group>
        </div>
        <div class="col-4">
            <x-form-group name="fator" value="{{ old('fator') }}">
                Fator
            </x-form-group>
        </div>
        <div class="col-4">
...
<input type="hidden" value="{{old('representante_id')}}" id="old_representante_id">
<input type="hidden" value="{{old('cliente_id')}}" id="old_cliente_id">
@endsection
@section('script')
<script>
    $(function() {
