    ...
    <table  class='page_break'>
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo 'R$ ' . number_format(350, 2, ',', '.'); ?></td>
                <td>
                    <?php echo 'R$ ' . number_format((350) * $vendas->sum('peso') * ($comissaoRepresentante["porcentagem_peso"] / 100), 2, ',', '.'); ?>
                </td>
            </tr>
            <tr>
                ...
                <td><?php echo 'R$ ' . number_format(13, 2, ',', '.'); ?></td>
                <td>
                    <?php echo 'R$ ' . number_format((13) * $vendas->sum('fator') * ($comissaoRepresentante["porcentagem_fator"] / 100), 2, ',', '.'); ?>
                </td>
            </tr>
            
            <tr>
                <td colspan=4><b>Total comissão - sem desconto</b></td>
                <td><b><?php echo 'R$ ' . number_format((350) * $vendas->sum('peso') * ($comissaoRepresentante["porcentagem_peso"] / 100)
                    +
                    (13) * $vendas->sum('fator') * ($comissaoRepresentante["porcentagem_fator"] / 100), 2, ',', '.'); ?></b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><b><?php echo 'R$ ' . number_format((350) * $vendas->sum('peso') * ($comissaoRepresentante["porcentagem_peso"] / 100)
                    +
                    (13) * $vendas->sum('fator') * ($comissaoRepresentante["porcentagem_fator"] / 100)
                    -
...
<?php /**PATH C:\Users\CAIXA\Desktop\Sistema\financeiro-main\resources\views/venda/pdf/pdf_conferencia_relatorio_vendas_sem_avista.blade.php ENDPATH**/ ?>