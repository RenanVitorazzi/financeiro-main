        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $cheques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cheque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class='titular'><?php echo e(substr($cheque->nome_cheque, 0 ,30)); ?></td>
                    ...
                    <td class='pagamentos'>
                        <?php $__currentLoopData = $pagamentos->where('parcela_id', $cheque->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pagamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php echo date('d/m/Y', strtotime($pagamento->data)); ?> - <?php echo e($pagamento->forma_pagamento); ?> <?php echo e($pagamento->conta->nome ??'NI'); ?> - <?php echo 'R$ ' . number_format($pagamento->valor, 2, ',', '.'); ?><?php echo e($pagamento->confirmado ? '' : ' - Não confirmado'); ?> <br>
...
<?php /**PATH C:\Users\CAIXA\Desktop\Sistema\financeiro-main\resources\views/entrega_parcela/pdf/pdf_cheques_entregues.blade.php ENDPATH**/ ?>