...
<?php $component->withAttributes(['class' => 'mr-2','href' => ''.e(route('pdf_conferencia_relatorio_vendas', ['representante_id' => $representante->id])).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('venda.create', ['id' => $representante->id])).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CAIXA\Desktop\Sistema\financeiro-main\resources\views/venda/show.blade.php ENDPATH**/ ?>