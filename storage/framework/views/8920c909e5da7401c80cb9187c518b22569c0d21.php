...
<div class='mb-2 d-flex justify-content-between'>
    <h3> <?php echo e($troca->titulo); ?> (<?php echo e($troca->taxa_juros); ?>%)</h3>
    <div>
...
<?php $component->withAttributes(['class' => 'mr-2','href' => ''.e(route('pdf_troca', $troca->id)).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    <tbody>
        <?php $__currentLoopData = $troca->cheques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cheque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td><p><?php echo e($cheque->parcelas->valor_parcela); ?></p></td>
                <td>
                    <p><?php echo e($cheque->valor_juros); ?></p>
                </td>
                <td>
                    <p><?php echo e($cheque->valor_liquido); ?></p>
                </td>
            </tr>
            <?php else: ?>
            <tr>
                <td><?php echo e($cheque->parcelas->nome_cheque); ?></td>
                <td><?php echo e($cheque->parcelas->numero_cheque); ?></td>
                <td><?php echo date('d/m/Y', strtotime($cheque->parcelas->data_parcela)); ?></td>
                <td><?php echo e($cheque->dias); ?></td>
                <td><?php echo e($cheque->parcelas->valor_parcela); ?></td>
                <td><?php echo e($cheque->valor_juros); ?></td>
                <td><?php echo e($cheque->valor_liquido); ?></td>
            </tr>
            <?php endif; ?>
    ...
    <tfoot>
            <tr>
                  ...
                  <th><b><?php echo e($troca->valor_bruto); ?></b></th>
                  <th><b><?php echo e($troca->valor_juros); ?></b></th>
                  <th><b><?php echo e($troca->valor_liquido); ?></b></th>
            </tr>
      </tfoot>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CAIXA\Desktop\Sistema\financeiro-main\resources\views/troca_cheque/show.blade.php ENDPATH**/ ?>