    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-4 form-group">
                ...
                <input class="form-control" disabled type="number" value="<?php echo e($conta_corrente->peso_bruto ?? ''); ?>"></input>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CAIXA\Desktop\Sistema\financeiro-main\resources\views/estoque/create.blade.php ENDPATH**/ ?>