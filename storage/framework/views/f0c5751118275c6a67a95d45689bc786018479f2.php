...
<?php endif; ?>
        ...
        <div class="col-6" id="group-peso_bruto" style="<?php echo e($contaCorrente->balanco == 'Débito' ?: 'display:none'); ?>">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-group','data' => ['name' => 'peso_bruto','type' => 'number','step' => '0.001','min' => '0','value' => ''.e($contaCorrente->peso_bruto).'']]); ?>
<?php $component->withName('form-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'peso_bruto','type' => 'number','step' => '0.001','min' => '0','value' => ''.e($contaCorrente->peso_bruto).'']); ?>Peso Bruto (g) <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
        ...
        <div class="col-3" id="group-cotacao" style="<?php echo e($contaCorrente->balanco == 'Crédito' ?: 'display:none'); ?>">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
        ...
        <div class="col-3" id="group-valor" style="<?php echo e($contaCorrente->balanco == 'Crédito' ?: 'display:none'); ?>">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CAIXA\Desktop\Sistema\financeiro-main\resources\views/contaCorrente/edit.blade.php ENDPATH**/ ?>