...
<?php $component->withAttributes(['class' => 'mr-2','href' => ''.e(route('pdf_despesa_mensal', $mes)).'']); ?> <?php if (isset($__componentOriginale7af6f5f93c3f23c2bd6667675861a3352692bb5)): ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('despesas.create')).'']); ?> <?php if (isset($__componentOriginale4c265d4ffee8fab925ff5f69279324cd3ba69cd)): ?>
...
<?php endif; ?>
        <tbody>
        <?php $__currentLoopData = $fixasNaoPagas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fixaNaoPaga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tbody>
                <td><?php echo e($fixaNaoPaga->nome); ?></td>
                <td><?php echo 'R$ ' . number_format($fixaNaoPaga->valor, 2, ',', '.'); ?></td>
                <td><?php echo e($fixaNaoPaga->dia_vencimento); ?></td>
                <td><?php echo e($fixaNaoPaga->local->nome); ?></td>
            </tbody>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'mr-2','href' => ''.e(route('despesas.edit', $despesa->id)).'']); ?> <?php if (isset($__componentOriginal13702a75d66702067dad623af293364e28e151a7)): ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['action' => ''.e(route('despesas.destroy', $despesa->id)).'']); ?> <?php if (isset($__componentOriginalc7dfdfe339a23ddfcb22882c80952c28748ef247)): ?>
...
<?php endif; ?>
        ...
        <tfoot>
            <tr>
                <th>Total</th>
                <th colspan=4><?php echo 'R$ ' . number_format($despesas->sum('valor'), 2, ',', '.'); ?></th>
            </tr>
        </tfoot>
    </tbody>
 <?php if (isset($__componentOriginale53a9d2e6d6c51019138cc2fcd3ba8ac893391c6)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BKP Asus\Usuário\Desktop\DL financeiro\DL-financeiro\resources\views/despesa/index.blade.php ENDPATH**/ ?>