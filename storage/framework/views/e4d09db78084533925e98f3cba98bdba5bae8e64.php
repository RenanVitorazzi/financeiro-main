...
<?php $component->withAttributes(['name' => 'nome','autofocus' => true,'value' => ''.e(old('nome')).'']); ?>Nome <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php $component->withAttributes(['name' => 'tipoCadastro','required' => true]); ?>
                        <option value='Pessoa Física' <?php echo e((old('tipoCadastro') == 'Pessoa Física') ? 'selected' : ''); ?> > Pessoa Física</option>
                        <option value='Pessoa Jurídica' <?php echo e((old('tipoCadastro') == 'Pessoa Jurídica') ? 'selected' : ''); ?> > Pessoa Jurídica</option>
...
<?php endif; ?>
            ...
            <div class="col-4">
                <div <?php echo e((old('tipoCadastro') == 'Pessoa Jurídica') ? 'style=display:none' : ''); ?> id='cpfGroup'>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-group','data' => ['name' => 'cpf']]); ?>
<?php $component->withName('form-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'cpf']); ?>CPF <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <div <?php echo e((old('tipoCadastro') == 'Pessoa Jurídica') ? '' : 'style=display:none'); ?> id='cnpjGroup'>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-group','data' => ['name' => 'cnpj']]); ?>
<?php $component->withName('form-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'cnpj']); ?>CPNJ <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
...
</div> <?php /**PATH D:\BKP Asus\Usuário\Desktop\DL financeiro\DL-financeiro\resources\views/formGeral.blade.php ENDPATH**/ ?>