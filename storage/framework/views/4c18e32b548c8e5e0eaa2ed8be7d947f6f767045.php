...
<form method="POST" action="<?php echo e(route('consignado.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-4">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-group','data' => ['name' => 'data','type' => 'date','value' => ''.e(old('data')).'']]); ?>
<?php $component->withName('form-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'data','type' => 'date','value' => ''.e(old('data')).'']); ?>
                Data
...
<?php endif; ?>
        ...
        <div class="col-4">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-group','data' => ['name' => 'peso','value' => ''.e(old('peso')).'']]); ?>
<?php $component->withName('form-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'peso','value' => ''.e(old('peso')).'']); ?>
                Peso
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php endif; ?>
        ...
        <div class="col-4">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-group','data' => ['name' => 'fator','value' => ''.e(old('fator')).'']]); ?>
<?php $component->withName('form-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'fator','value' => ''.e(old('fator')).'']); ?>
                Fator
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<input type="hidden" value="<?php echo e(old('representante_id')); ?>" id="old_representante_id">
<input type="hidden" value="<?php echo e(old('cliente_id')); ?>" id="old_cliente_id">
<?php $__env->stopSection(); ?>
    ...
    $(function() {
        ...
        function popularOption(response) {
            if (response.length === 0) {
                Swal.fire(
                    'Atenção!',
                    'Nenhum cliente cadastrado para esse representante',
                    'warning'
                )
                return;
            }
            ...
            $("#cliente_id").empty().append(option)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BKP Asus\Usuário\Desktop\DL financeiro\DL-financeiro\resources\views/consignado/create.blade.php ENDPATH**/ ?>